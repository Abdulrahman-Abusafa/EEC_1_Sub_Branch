      ...
      <section className="min-h-[60vh] flex flex-col lg:flex-row items-center justify-between text-center lg:text-left gap-10 relative perspective-1000">
        ...
        <div className="flex flex-col gap-6 items-center lg:items-start max-w-2xl z-10">
            ...
            <div className="flex gap-6 mt-4">
                <Link href="/academics">
                    <button className="px-8 py-3 bg-gray-900 dark:bg-white text-white dark:text-black rounded-full font-medium hover:bg-gray-800 dark:hover:bg-white/90 transition-all flex items-center gap-2 shadow-[0_0_30px_rgba(0,0,0,0.1)] dark:shadow-[0_0_30px_rgba(255,255,255,0.1)]">
